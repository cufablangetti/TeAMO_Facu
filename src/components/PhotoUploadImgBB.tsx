...
// const PhotoUploadImgBB: React.FC<PhotoUploadProps> = ({ onPhotosUploaded }) => {
...
//   // API Key de ImgBB (tendrías que obtener una gratis en https://api.imgbb.com/)
//   const IMGBB_API_KEY = 'c76cf58613a488c3b14fee596a71898a'; // Reemplazar con tu API key real
...
//     // Filtrar solo imágenes y limitar a 3 fotos para no sobrecargar
...
//       // Guardar URLs en localStorage como respaldo
//       const existingPhotos = JSON.parse(localStorage.getItem('koreaPhotos') || '[]');
//       const newPhotos = [...existingPhotos, ...photosWithTimestamp];
//       localStorage.setItem('koreaPhotos', JSON.stringify(newPhotos));
...
//                         Selecciona fotos del viaje a Corea
//                       </span>
...
//                     Las fotos se subirán a ImgBB y estarán disponibles para todos
//                   </p>
//                 </div>
//               )}
//             </div>
...
// export default PhotoUploadImgBB;